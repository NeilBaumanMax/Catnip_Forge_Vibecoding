...
async def load_config():
    ...
    if os.environ.get("FORGE_RADIO") == "1":
        custom_config = {
            "server": {"ip": "127.0.0.1", "port": int(os.environ.get("FORGE_XIAOZHI_PORT", "8000")), "auth_key": os.environ["FORGE_SERVICE_TOKEN"], "auth": {"enabled": False}},
            "selected_module": {"LLM": "ForgeLLM", "TTS": "EdgeTTS", "Memory": "nomem", "Intent": "function_call"},
            "LLM": {"ForgeLLM": {"type": "openai", "model_name": os.environ["XIAOZHI_LLM_MODEL"], "base_url": os.environ["XIAOZHI_LLM_BASE_URL"], "api_key": os.environ.get("XIAOZHI_LLM_API_KEY", "local"), "timeout": 60}},
            "Intent": {"function_call": {"type": "function_call", "functions": ["forge_zhihu"]}},
            "log": {"log_level": "WARNING"},
            "prompt": "你是 Forge 电台的小智。使用工具获取资料，不能发帖。",
