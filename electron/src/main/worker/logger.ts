...
type LogEvent =
  ...
  | 'claude:session'
  | 'first-run:detected' | 'first-run:apikey-saved' | 'first-run:apikey-save-failed' | 'first-run:credential-saved' | 'first-run:credential-migration' | 'first-run:apikey-copied-from-resources' | 'first-run:apikey-copy-failed' | 'first-run:status' | 'first-run:restart-scheduled' | 'first-run:restarting'
