...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  getRadioStatus: () => ipcRenderer.invoke('radio:status'),
  startRadio: () => ipcRenderer.invoke('radio:start'),
  restartRadio: () => ipcRenderer.invoke('radio:restart'),
  stopRadio: () => ipcRenderer.invoke('radio:stop'),
  ...
  previewClaudeProvider: (providerId: string) => ipcRenderer.invoke('models:claude-provider:preview', providerId),
  listClaudeProviderModels: (providerId: string, expectedRevision: number) => ipcRenderer.invoke('models:claude-provider:models', providerId, expectedRevision),
  testClaudeProvider: (providerId: string, expectedRevision: number) => ipcRenderer.invoke('models:claude-provider:test', providerId, expectedRevision),
