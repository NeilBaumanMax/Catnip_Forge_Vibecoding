  ...
  return (
    <section className="model-center" data-tour-id="panel-models">
      ...
      <div className="model-provider-workspace">
        ...
        <main className="model-provider-editor" data-tour-id="model-provider-editor">
          {provider?.claudeCode ? <>
