import type { AddVerificationRecordInput, ExploreRequest, ExploreRequestPreparation, ExploreZhihuConnectionStatus, KnowledgeCard, SaveKnowledgeCardInput } from '../../common/explore';
