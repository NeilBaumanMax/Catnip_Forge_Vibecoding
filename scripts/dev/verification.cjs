...
const SAFE = new Set([
  ...
  'verify:task-history', 'verify:explore-history', 'verify:explore-knowledge-preview', 'verify:explore-analysis-results', 'verify:explore-plan-view',
]);
...
const GROUPS = {
  'explore-core': CORE,
  explore: [...CORE, 'verify:explore-session', 'verify:explore-knowledge', 'verify:explore-context', 'verify:explore-zhihu-connection', 'verify:explore-ui', 'verify:explore-entry', 'verify:explore-history', 'verify:explore-knowledge-preview', 'verify:explore-analysis-results', 'verify:explore-plan-view'],
