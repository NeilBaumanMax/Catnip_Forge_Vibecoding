...
const SAFE = new Set([
  ...
  'verify:task-history', 'verify:task-history-panel', 'verify:task-controls-panel', 'verify:explore-history', 'verify:explore-knowledge-preview', 'verify:explore-analysis-results', 'verify:explore-plan-view', 'verify:explore-connection-status', 'verify:explore-output-empty-state',
]);
