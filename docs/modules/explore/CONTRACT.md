...
## Relevant Tests
FAST：verify:explore-ui、verify:explore-entry。
MODULE：verify:explore-request、verify:explore-analysis-gate、verify:explore-search-handoff、verify:explore-session、verify:explore-knowledge、verify:explore-context、verify:explore-zhihu-connection。
