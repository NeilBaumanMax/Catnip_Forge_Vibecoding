...
> 归档提示：本文主体冻结在 2026-08-08 的 v1.5.0 / `main` 历史现场，不再是当前接力入口。2026-09-11 起请先读 [当前施工 HANDOFF](construction/HANDOFF.md)；当前施工分支为 `catnip-GUAGUA`，当前公开版本为 v2.0.0 / Build 7201。
...
- 仓库 remote：`origin`
- SSH 连接由本机 Git 配置管理，不在项目文档中记录身份信息
...
3. 提交到 Git。
4. 推送当前施工分支到 remote `origin`，查询远端并确认提交号；未经合并验收不直接推入 `main`。
